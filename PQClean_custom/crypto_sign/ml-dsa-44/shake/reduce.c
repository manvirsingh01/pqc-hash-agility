...
/*************************************************
* Name:        PQCLEAN_MLDSA44_SHAKE_montgomery_reduce
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_SHAKE_reduce32
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_SHAKE_caddq
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_SHAKE_freeze
*
...
int32_t PQCLEAN_MLDSA44_SHAKE_freeze(int32_t a) {
    a = PQCLEAN_MLDSA44_SHAKE_reduce32(a);
    a = PQCLEAN_MLDSA44_SHAKE_caddq(a);
    return a;
}
