...
/*************************************************
* Name:        PQCLEAN_MLDSA44_SHAKE_power2round
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_SHAKE_decompose
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_SHAKE_make_hint
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_SHAKE_use_hint
*
...
int32_t PQCLEAN_MLDSA44_SHAKE_use_hint(int32_t a, unsigned int hint) {
    ...
    a1 = PQCLEAN_MLDSA44_SHAKE_decompose(&a0, a);
    if (hint == 0) {
        return a1;
    }
