...
/*************************************************
* Name:        PQCLEAN_MLDSA44_XOODYAK_montgomery_reduce
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_XOODYAK_reduce32
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_XOODYAK_caddq
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA44_XOODYAK_freeze
*
...
int32_t PQCLEAN_MLDSA44_XOODYAK_freeze(int32_t a) {
    a = PQCLEAN_MLDSA44_XOODYAK_reduce32(a);
    a = PQCLEAN_MLDSA44_XOODYAK_caddq(a);
    return a;
}
