...
/*************************************************
* Name:        PQCLEAN_MLDSA87_HARAKA_power2round
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_HARAKA_decompose
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_HARAKA_make_hint
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_HARAKA_use_hint
*
...
int32_t PQCLEAN_MLDSA87_HARAKA_use_hint(int32_t a, unsigned int hint) {
    ...
    a1 = PQCLEAN_MLDSA87_HARAKA_decompose(&a0, a);
    if (hint == 0) {
        return a1;
    }
