...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_reduce
*
...
void PQCLEAN_MLDSA87_BLAKE3_poly_reduce(poly *a) {
    ...
    for (i = 0; i < N; ++i) {
        a->coeffs[i] = PQCLEAN_MLDSA87_BLAKE3_reduce32(a->coeffs[i]);
    }
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_caddq
*
...
void PQCLEAN_MLDSA87_BLAKE3_poly_caddq(poly *a) {
    ...
    for (i = 0; i < N; ++i) {
        a->coeffs[i] = PQCLEAN_MLDSA87_BLAKE3_caddq(a->coeffs[i]);
    }
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_add
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_sub
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_shiftl
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_ntt
*
...
void PQCLEAN_MLDSA87_BLAKE3_poly_ntt(poly *a) {
    ...
    PQCLEAN_MLDSA87_BLAKE3_ntt(a->coeffs);

    DBENCH_STOP(*tmul);
}

/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_invntt_tomont
*
...
void PQCLEAN_MLDSA87_BLAKE3_poly_invntt_tomont(poly *a) {
    ...
    PQCLEAN_MLDSA87_BLAKE3_invntt_tomont(a->coeffs);

    DBENCH_STOP(*tmul);
}

/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_pointwise_montgomery
*
...
void PQCLEAN_MLDSA87_BLAKE3_poly_pointwise_montgomery(poly *c, const poly *a, const poly *b) {
    ...
    for (i = 0; i < N; ++i) {
        c->coeffs[i] = PQCLEAN_MLDSA87_BLAKE3_montgomery_reduce((int64_t)a->coeffs[i] * b->coeffs[i]);
    }
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_power2round
*
...
void PQCLEAN_MLDSA87_BLAKE3_poly_power2round(poly *a1, poly *a0, const poly *a) {
    ...
    for (i = 0; i < N; ++i) {
        a1->coeffs[i] = PQCLEAN_MLDSA87_BLAKE3_power2round(&a0->coeffs[i], a->coeffs[i]);
    }
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_decompose
*
* Description: For all coefficients c of the input polynomial,
...
void PQCLEAN_MLDSA87_BLAKE3_poly_decompose(poly *a1, poly *a0, const poly *a) {
    ...
    for (i = 0; i < N; ++i) {
        a1->coeffs[i] = PQCLEAN_MLDSA87_BLAKE3_decompose(&a0->coeffs[i], a->coeffs[i]);
    }
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_make_hint
*
...
unsigned int PQCLEAN_MLDSA87_BLAKE3_poly_make_hint(poly *h, const poly *a0, const poly *a1) {
    ...
    for (i = 0; i < N; ++i) {
        h->coeffs[i] = PQCLEAN_MLDSA87_BLAKE3_make_hint(a0->coeffs[i], a1->coeffs[i]);
        s += h->coeffs[i];
    }
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_use_hint
*
...
void PQCLEAN_MLDSA87_BLAKE3_poly_use_hint(poly *b, const poly *a, const poly *h) {
    ...
    for (i = 0; i < N; ++i) {
        b->coeffs[i] = PQCLEAN_MLDSA87_BLAKE3_use_hint(a->coeffs[i], h->coeffs[i]);
    }
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_chknorm
*
* Description: Check infinity norm of polynomial against given bound.
*              Assumes input coefficients were reduced by PQCLEAN_MLDSA87_BLAKE3_reduce32().
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_uniform
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_poly_uniform_eta
*
* Description: Sample polynomial with uniformly random coefficients
...
void PQCLEAN_MLDSA87_BLAKE3_poly_uniform_gamma1(poly *a,
    ...
    stream256_release(&state);
    PQCLEAN_MLDSA87_BLAKE3_polyz_unpack(a, buf);
}
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyeta_pack
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyeta_unpack
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyt1_pack
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyt1_unpack
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyt0_pack
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyt0_unpack
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyz_pack
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyz_unpack
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA87_BLAKE3_polyw1_pack
*
