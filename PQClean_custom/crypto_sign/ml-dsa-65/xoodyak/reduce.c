...
/*************************************************
* Name:        PQCLEAN_MLDSA65_XOODYAK_montgomery_reduce
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_XOODYAK_reduce32
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_XOODYAK_caddq
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_XOODYAK_freeze
*
...
int32_t PQCLEAN_MLDSA65_XOODYAK_freeze(int32_t a) {
    a = PQCLEAN_MLDSA65_XOODYAK_reduce32(a);
    a = PQCLEAN_MLDSA65_XOODYAK_caddq(a);
    return a;
}
