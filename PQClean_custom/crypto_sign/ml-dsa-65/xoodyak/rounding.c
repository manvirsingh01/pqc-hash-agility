...
/*************************************************
* Name:        PQCLEAN_MLDSA65_XOODYAK_power2round
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_XOODYAK_decompose
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_XOODYAK_make_hint
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_XOODYAK_use_hint
*
...
int32_t PQCLEAN_MLDSA65_XOODYAK_use_hint(int32_t a, unsigned int hint) {
    ...
    a1 = PQCLEAN_MLDSA65_XOODYAK_decompose(&a0, a);
    if (hint == 0) {
        return a1;
    }
