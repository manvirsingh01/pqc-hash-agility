...
/*************************************************
* Name:        PQCLEAN_MLDSA65_BLAKE3_montgomery_reduce
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_BLAKE3_reduce32
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_BLAKE3_caddq
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_BLAKE3_freeze
*
...
int32_t PQCLEAN_MLDSA65_BLAKE3_freeze(int32_t a) {
    a = PQCLEAN_MLDSA65_BLAKE3_reduce32(a);
    a = PQCLEAN_MLDSA65_BLAKE3_caddq(a);
    return a;
}
