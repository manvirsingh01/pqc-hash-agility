...
/*************************************************
* Name:        PQCLEAN_MLDSA65_BLAKE3_power2round
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_BLAKE3_decompose
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_BLAKE3_make_hint
*
...
/*************************************************
* Name:        PQCLEAN_MLDSA65_BLAKE3_use_hint
*
...
int32_t PQCLEAN_MLDSA65_BLAKE3_use_hint(int32_t a, unsigned int hint) {
    ...
    a1 = PQCLEAN_MLDSA65_BLAKE3_decompose(&a0, a);
    if (hint == 0) {
        return a1;
    }
