...
/*
 * PQCLEAN_MLKEM1024_TURBO_kyber_turboshake128_absorb
 ...
 */
void PQCLEAN_MLKEM1024_TURBO_kyber_turboshake128_absorb(xof_state *state,
...
void PQCLEAN_MLKEM1024_TURBO_kyber_turboshake_squeezeblocks(uint8_t *out, size_t nblocks, xof_state *state) {
    TurboSHAKE_Squeeze(state, out, nblocks * XOF_BLOCKBYTES);
}

void PQCLEAN_MLKEM1024_TURBO_kyber_turboshake_ctx_release(xof_state *state) {
    (void)state;
}

/*
 * PQCLEAN_MLKEM1024_TURBO_kyber_turboshake256_prf
...
/*
 * PQCLEAN_MLKEM1024_TURBO_kyber_turboshake256_rkprf
