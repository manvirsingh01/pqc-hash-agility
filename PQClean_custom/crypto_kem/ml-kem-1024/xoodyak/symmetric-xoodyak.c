...
/*
 * PQCLEAN_MLKEM1024_XOODYAK_kyber_xoodyak_absorb
 ...
 */
void PQCLEAN_MLKEM1024_XOODYAK_kyber_xoodyak_absorb(xof_state *state,
...
void PQCLEAN_MLKEM1024_XOODYAK_kyber_xoodyak_squeezeblocks(uint8_t *out, size_t nblocks, xof_state *state) {
    Xoodyak_Squeeze(state, out, nblocks * XOF_BLOCKBYTES);
}

void PQCLEAN_MLKEM1024_XOODYAK_kyber_xoodyak_ctx_release(xof_state *state) {
    (void)state;
}

/*
 * PQCLEAN_MLKEM1024_XOODYAK_kyber_xoodyak_prf
...
/*
 * PQCLEAN_MLKEM1024_XOODYAK_kyber_xoodyak_rkprf
