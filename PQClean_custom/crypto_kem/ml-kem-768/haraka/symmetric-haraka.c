...
/*
 * PQCLEAN_MLKEM768_HARAKA_kyber_haraka_absorb
 ...
 */
void PQCLEAN_MLKEM768_HARAKA_kyber_haraka_absorb(xof_state *state,
...
void PQCLEAN_MLKEM768_HARAKA_kyber_haraka_squeezeblocks(uint8_t *out, size_t nblocks, xof_state *state) {
    size_t i;
    for (i = 0; i < nblocks; i++) {
...
void PQCLEAN_MLKEM768_HARAKA_kyber_haraka_ctx_release(xof_state *state) {
    (void)state;
}

/*
 * PQCLEAN_MLKEM768_HARAKA_kyber_haraka_prf
...
/*
 * PQCLEAN_MLKEM768_HARAKA_kyber_haraka_rkprf
