...
/*
 * PQCLEAN_MLKEM768_BLAKE3_kyber_blake3_absorb
 ...
 */
void PQCLEAN_MLKEM768_BLAKE3_kyber_blake3_absorb(xof_state *state,
...
void PQCLEAN_MLKEM768_BLAKE3_kyber_blake3_squeezeblocks(uint8_t *out, size_t nblocks, xof_state *state) {
...
void PQCLEAN_MLKEM768_BLAKE3_kyber_blake3_ctx_release(xof_state *state) {
    (void)state;
}

/*
 * PQCLEAN_MLKEM768_BLAKE3_kyber_blake3_prf
...
/*
 * PQCLEAN_MLKEM768_BLAKE3_kyber_blake3_rkprf
