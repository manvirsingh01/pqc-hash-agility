...
/*
 * PQCLEAN_MLKEM768_K12_kyber_k12_absorb
 ...
 */
void PQCLEAN_MLKEM768_K12_kyber_k12_absorb(xof_state *state,
...
void PQCLEAN_MLKEM768_K12_kyber_k12_squeezeblocks(uint8_t *out, size_t nblocks, xof_state *state) {
    KangarooTwelve_Squeeze(state, out, nblocks * XOF_BLOCKBYTES);
}

void PQCLEAN_MLKEM768_K12_kyber_k12_ctx_release(xof_state *state) {
    (void)state;
}

/*
 * PQCLEAN_MLKEM768_K12_kyber_k12_prf
...
/*
 * PQCLEAN_MLKEM768_K12_kyber_k12_rkprf
